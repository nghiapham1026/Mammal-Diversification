...
#data = pd.read_csv('../../data/processed/taxon/Mammal_Diversity.csv')
data = pd.read_csv('../../data/processed/taxon/interpolated/Mammal_Diversity_interpolated.csv')
...
plt.title('Mammal Diversity Over Time')
